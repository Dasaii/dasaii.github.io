...
### TL;DR
At [Mind Candy](http://mindcandy.com) we build a safe, creative community for kids. PopJam is a space where <13s can create/ share art and engage with their favourite brands. We grew it to over 1m users and PopJam was sold to [SuperAwesome](https://superawesome.tv) in 2015.
...
![JellyChat v1.0 - Character driven](/images/popjam/jellychat1.png "Character driven")
...
![JellyChat v1.0 - Animation in chat](/images/popjam/jellychat2.png "Animation in chat")
The beans were then used to make chat more fun, kids could send 3d animated 'pokes' to each other of their beans interacting (kind of like 3D Bitmoji today). The bean avatars would also react to the chat conversion, laughing at a 'lol' or crying at a sad face emoji.

![JellyChat v1.0 - Creative tools](/images/popjam/jellychat3.png "Creative tools")
...
![JellyChat v2.0 - Creative community](/images/popjam/jellychat4.png "Creative community")
#### Creative community
...
![JellyChat v2.0 - Content feed](/images/popjam/jellychat5.png "Content feed")
#### The feed
...
![JellyChat v2.0 - A place for things kids love](/images/popjam/jellychat6.png "A place for things kids love")
#### A place for things kids love
To help ensure kids had content to enjoy immediately we create the concept of 'Channels'. Channels were internally run accounts that would share fun images, creates, games, memes and polls around interest areas allowing kids to follow the channels they found the most interesting. New users already followed our most popular channels giving immediate value to new users. The plan was to grow channels by working with brands to features kids favourite products/IP - we started internally with Moshi channels and fan pages to test the concept. One of the most successful non-branded channels was the Daily Challenge which gave a fun competition for all users to compete in everyday with the winner getting featured in the Hall of Fame! Fun fact, I made myself the first member of the Hall of Fame

![JellyChat v2.0 - Safety first](/images/popjam/jellychat7.png "Safety first")
#### Safety first
While JellyChat v1.0 did feature lots of safety features to ensure that kids were safe in their chat, it was primarily designed for kids to talk to their friends who they already knew. The addition of the social feed made it much easier for kids to find new people to follow and engage with. To ensure that all content remained appropriate we built in sophisticated moderation tools and enlisted the Moshi Monsters moderation team to moderate JellyChat 24/7. All public posts were pre-moderated before appearing to everybody ensuring content met our strict guidelines.

![JellyChat v2.0 - Summary](/images/popjam/jellychat8.png "Summary")
